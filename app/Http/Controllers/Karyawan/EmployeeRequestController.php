...
class EmployeeRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('karyawan.pengajuan.index', [
            ...
            'menungguJawaban' => PengajuanModel::query()
                ...
                ->whereHas('swap', fn ($q) => $q->where('partner_employee_id', $employeeId))
                ->get(),
        ]);
    }
    ...
    public function store(string $type, Request $request)
    {
        ...
        try {
            $pengajuan = match ($requestType) {
                ...
                RequestType::Overtime => $this->service->submitOvertime($employee, $request->validate([
    ...
    public function show(PengajuanModel $request, Request $httpRequest)
    {
        ...
        $sayaRekan = $request->swap?->partner_employee_id === $employeeId;
    ...
    public function respond(PengajuanModel $request, Request $httpRequest)
    {
        ...
        return back()->with('status', $data['accepted']
            ? 'Anda menerima. Sekarang menunggu persetujuan manager.'
            : 'Anda menolak permintaan tukar shift ini.');
    }
}
